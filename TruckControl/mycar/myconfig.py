...
PWM_STEERING_THROTTLE = {
    ...
    "STEERING_RIGHT_PWM": 530,              #pwm value for full right steering
    "THROTTLE_FORWARD_PWM": 290,            #pwm value for max forward throttle
    "THROTTLE_STOPPED_PWM":  400,            #pwm value for no movement
    "THROTTLE_REVERSE_PWM": 510,            #pwm value for max reverse throttle
    "PWM_GEARBOX_PIN": "PCA9685.1:40.2",    # PWM output pin for gearbox servo
    "PWM_GEARBOX_SCALE": 1.0,               # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
    "PWM_GEARBOX_INVERTED": False,
    "GEARBOX_FIRST": 290,                   # pwm value for first gear
    "GEARBOX_SECOND": 400,                  # pwm value for second gear
    "GEARBOX_THIRD": 590,                   # pwm value for third gear
}
# 
# #
