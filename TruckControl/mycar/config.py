...
PWM_STEERING_THROTTLE = {
    ...
    "PWM_GEARBOX_PIN": "PCA9685.7:40.2",    # PWM output pin for gearbox servo
    "PWM_GEARBOX_SCALE": 1.0,               # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
    "PWM_GEARBOX_INVERTED": False,         # True if hardware requires an inverted PWM pulse
    "GEARBOX_FIRST": 300,                   # pwm value for first gear
    "GEARBOX_SECOND": 400,                  # pwm value for second gear
    "GEARBOX_THIRD": 500,                   # pwm value for third gear
}
